        ...
        <main className={classes.main}>
            ...
            <section className={classes.contentTableSection}>
              <div className={classes.textContainer}>
                <ul className={classes.contentTable}>
                  <li><a className={classes.link} href="#">Кто мы</a></li>
                  <li><a className={classes.link} href="#">Зачем и как собирались</a></li>
          ...
          <section className={classes.intro}>
            <div className={classes.textContainer}>
              ...
              Путешествие заняло 44 дня, 24 из которых &mdash; в седле. Заезд разделился на два этапа, Калининград&nbsp;&mdash;&nbsp;Амстердам и Копенгаген&nbsp;&mdash;&nbsp;Стокгольм. В сумме на велосипедах мы проехали более 2000 км. Здесь наша короткая история с маршрутом, фотографиями и некоторыми комментариями.
            </div>
          </section>
          <p>
